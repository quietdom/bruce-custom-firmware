🌐 [English](../README.md) | [Portugues](README_PT.md) | [Italiano](README_IT.md) | [Francais](README_FR.md) | 🇷🇺 [Русский](README_RU.md) | 🇨🇳 [中文](README_ZH.md) | [Polski](README_PL.md) | [Nederlands](README_NL.md) | [Turkce](README_TR.md) | [Deutsch](README_DE.md) | **Tiếng Việt** [Tiếng Việt](README_VN.md) | [Espanol](README_ES.md) | [Indonesia](README_ID.md) | 🇸🇦 [العربية](README_AR.md)
...
<p align="center">
  <b>Firmware bảo mật tấn công tùy chỉnh cho thiết bị ESP32</b><br>
  <i>72 công cụ Full / 55 công cụ LITE - Một firmware - Nhiều thiết bị</i>
</p>

---

Một phiên bản chỉnh sửa của [Bruce Firmware](https://github.com/pr3y/Bruce) với mô-đun **Arsenal** tùy chỉnh. Tất cả các tính năng gốc của Bruce vẫn được giữ nguyên.

## Cài đặt

1. Tải xuống `.bin` từ [Releases](../../releases)
2. Flash qua [ESP Web Flasher](https://espressif.github.io/esptool-js/) (Chrome/Edge) hoặc OTA qua Arsenal Dashboard

---

## Công cụ Arsenal (72 Full / 55 LITE)

| # | Công cụ | Full | LITE | | # | Công cụ | Full | LITE |
|---|------|:----:|:----:|-|---|------|:----:|:----:|
...
Arsenal > Dashboard. Kết nối với `ArsenalNet` (mật khẩu: `arsenal32`). Mở `192.168.4.1`.

## Tín dụng

- [Bruce Firmware](https://github.com/pr3y/Bruce) bởi pr3y
- Mô-đun Arsenal bởi quietdom

## Từ chối trách nhiệm

Chỉ dành cho kiểm tra bảo mật được ủy quyền và mục đích giáo dục.