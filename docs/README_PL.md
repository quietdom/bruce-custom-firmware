🌐 [English](../README.md) | [Portugues](README_PT.md) | [Italiano](README_IT.md) | [Francais](README_FR.md) | 🇷🇺 [Русский](README_RU.md) | 🇨🇳 [中文](README_ZH.md) | **Polski** | [Nederlands](README_NL.md) | [Turkce](README_TR.md) | [Deutsch](README_DE.md) | Tiếng Việt [Tiếng Việt](README_VN.md) | [Espanol](README_ES.md) | [Indonesia](README_ID.md) | 🇸🇦 [العربية](README_AR.md)
...
<p align="center">
  <b>Niestandardowy firmware do testów penetracyjnych dla urządzeń ESP32</b><br>
  <i>72 narzędzi Full / 55 narzędzi LITE - Jeden firmware - Wiele urządzeń</i>
</p>

---

Zmodyfikowany [Bruce Firmware](https://github.com/pr3y/Bruce) z niestandardowym modułem **Arsenal**. Wszystkie oryginalne funkcje Bruce pozostają nienaruszone.

## Instalacja

1. Pobierz `.bin` z [Releases](../../releases)
2. Flash przez [ESP Web Flasher](https://espressif.github.io/esptool-js/) (Chrome/Edge) lub OTA przez Arsenal Dashboard

---

## Narzędzia Arsenal (72 Full / 55 LITE)

| # | Narzędzie | Full | LITE | | # | Narzędzie | Full | LITE |
|---|------|:----:|:----:|-|---|------|:----:|:----:|
...
Arsenal > Dashboard. Połącz się z `ArsenalNet` (hasło: `arsenal32`). Otwórz `192.168.4.1`.

## Podziękowania

- [Bruce Firmware](https://github.com/pr3y/Bruce) przez pr3y
- Moduł Arsenal przez quietdom

## Zastrzeżenie

Tylko do autoryzowanych testów bezpieczeństwa i celów edukacyjnych.